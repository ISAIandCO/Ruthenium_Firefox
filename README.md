...
![Иконка RFirefox: лиса формирует букву R](branding/android/rfirefox-xxxhdpi.webp)
...
- Основная launcher-иконка — отдельная иллюстрация лисы в форме `R`, созданная
  с опорой на визуальный язык Firefox; в интерфейсе и альтернативных иконках
  также остаются товарные знаки Firefox. Перед широким публичным
  распространением нужна проверка Mozilla Trademark Guidelines.
