...
месяца в 03:17 UTC. Перед дорогой сборкой workflow проверяет GitHub Releases. Если debug-релиз текущей
...
- три устанавливаемых APK для arm64-v8a, armeabi-v7a и x86, подписанные закреплённым debug-ключом;
